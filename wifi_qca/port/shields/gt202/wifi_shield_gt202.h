...
#define WIFISHIELD_WLAN_PINT_CONNECT (kINPUTMUX_GpioPort1Pin9ToPintsel)
...
#define WIFISHIELD_WLAN_IRQ_PIN  (BOARD_INITGT202SHIELD_IRQ_PIN)
...
#define WIFISHIELD_WLAN_PWRON_PIN  (BOARD_INITGT202SHIELD_PWRON_PIN)
